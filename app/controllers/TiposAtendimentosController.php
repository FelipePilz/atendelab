...
class TiposAtendimentosController
{
    ...
    public function buscar(): void
    {
        ...
        if (!$tipo) {
            $this->json(['erro' => 'Tipo não encontrada'], 404);
            return;
        }
        $this->json($tipo);
    }
    ...
    public function criar(): void
    {
        ...
        try {
            ...
            $this->json(['mensagem' => 'Tipo cadastrado com suceso.'], 201);
        } catch (PDOException $e) {
            $this->json(['erro' => 'Não foi possível cadastrar o tipo.'], 400);
        }
    }
    ...
    public function atualizar(): void
    {
        ...
        try {
            ...
            $this->json(['mensagem' => 'Tipo atualizado com suceso.']);
        } catch (PDOException $e) {
            $this->json(['erro' => 'Não foi possível atualizar o tipo.'], 400);
        }
    }
