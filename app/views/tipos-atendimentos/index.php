...
<div class="card border-0 shadow-sm mb-4 d-none" id="cardFormulario">
    <div class="card-body">
        ...
        <form id="formTipo">
            ...
            <div class="d-flex gap-2 mt-3"><button class="btn
btn-success">Salvar</button>
                <buttonclass="btn btn-outline-secondary" type="button" onclick="fecharFormulario()">Cancelar</button>
            </div>
        </form>
    </div>
</div>
    ...
    async function editarTipo(id) {
        try {
            ...
            for (const [nomeCampo, valorCampo] of Object.entries(tipo)) {
                const campo = formTipo.elements.namedItem(nomeCampo); if (campo) {
