        ...
        <form id="formAtendimento">
            ...
            <div class="d-flex gap-2 mt-3">
                <button class="btn btn-success" type="submit">
                    Registrar
                </button><button class="btn btn-outline-secondary" type="button" onclick="fecharFormulario()">
                    Cancelar
                </button>
            </div>
        </form>
 ...
 `;
    ...
    function abrirStatus(id, status) {
        ...
        document.querySelector('#formStatus [name="status"]').value =
            status || 'aberto'; document.querySelector('#formStatus [name="observacao_final"]').value = '';
        statusModal().show();
    }
